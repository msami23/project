                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> تعديل - {{$mainCategories -> name}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form"
                                          action="{{route('admin.main_categories.update',$mainCategories -> id)}}"
                                          method="POST"
                                          enctype="multipart/form-data">
                                        @csrf

                                        <input name="id" value="{{$mainCategories -> id}}" type="hidden">

                                        <div class="form-group">
                                            <div class="text-center">
                                                <img
                                                    src="{{$mainCategories -> photo}}"
                                    ...
                                    <ul class="nav nav-tabs">
                                        @isset($mainCategories -> categories)
                                            @foreach($mainCategories -> categories   as $index =>  $translation)
                                                <li class="nav-item">
